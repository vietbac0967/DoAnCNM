...
const ContentUpdateAVT = (props) => {
    ...
    const handleUpdateAVT = async (e) => {
        if (fileupdate) {
            ...
            let res = await updateAVTUser(formData)
            if (res && res.EC === 0) {
                setSuccess(true);
                setLoading(false);
...
export default ContentUpdateAVT;